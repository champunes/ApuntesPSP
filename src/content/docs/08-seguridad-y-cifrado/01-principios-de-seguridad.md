...
> 🗺️ **Estás en:** 🔐 **UD 9 · Seguridad y cifrado** → 01 · Principios de seguridad
...
- **Cifra todo** — Los datos viajan por la red (en tránsito, con TLS) y descansan en el disco (en reposo). En esta unidad ciframos en reposo las contraseñas con hash; en los puntos 5 y 6 cifrarás mensajes completos con AES y RSA.
...
- **No inventes tu cripto** — La tentación de escribir "mi propio algoritmo" es enorme… y siempre termina mal. Las bibliotecas como `hashlib` o `cryptography` llevan décadas siendo atacadas y parcheadas. Tú no puedes hacer eso en un finde.
...
> Cuando en el [punto 3](/ApuntesPSP/08-seguridad-y-cifrado/03-contrasenas-seguras) guardes una contraseña con hash, estarás instalando una cerradura decente. Cuando añadas **sal**, estarás poniendo la segunda vuelta.
...
1. Porque la criptografía necesita **años de ataques y auditorías** para ser fiable. Tu algoritmo casero puede tener una puerta trasera que ni tú conoces. Las bibliotecas estándar (`hashlib`, `cryptography`) ya pasaron ese proceso.
...
📚 [Volver al índice de la unidad](/ApuntesPSP/08-seguridad-y-cifrado) · **Siguiente:** [02 · Hash y huellas digitales](/ApuntesPSP/08-seguridad-y-cifrado/02-hash-y-huellas-digitales)
