...
> 🗺️ **Estás en:** ⏱️ **UD 10 · Alta disponibilidad** → 01 · Event Loop
...
Viene directo del problema que dejaste en la [UD 6 · Servidores concurrentes](/ApuntesPSP/05-servidores-concurrentes): un servidor que usa `accept()` y `recv()` se **bloquea** mientras espera. La solución de la UD 6 fueron los hilos. La de hoy es distinta: **un solo hilo que cambia de tarea cuando una espera**.
...
1. Porque el hilo que ejecuta esa línea **se queda parado** esperando datos: mientras tanto no puede atender a nadie (el problema del servidor secuencial de la [UD 6](/ApuntesPSP/05-servidores-concurrentes)).
...
📚 [Volver al índice de la unidad](/ApuntesPSP/09-alta-disponibilidad) · **Siguiente:** [02 · Corrutinas](/ApuntesPSP/09-alta-disponibilidad/02-corrutinas)